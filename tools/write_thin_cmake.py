...
set_source_files_properties(${CMAKE_CURRENT_LIST_DIR}/portable/portasm.S PROPERTIES COMPILE_FLAGS "-x assembler-with-cpp -D __riscv64")
...
include_directories(${CMAKE_CURRENT_LIST_DIR}/include)
set_source_files_properties(${CMAKE_CURRENT_LIST_DIR}/crt.S PROPERTIES COMPILE_FLAGS "-x assembler-with-cpp -D __riscv64")
...
print("THIN_BOOT_CMAKE_OK no_lwip=1 no_esp_flasher=1 no_pwm_dvp_i2s=1")
